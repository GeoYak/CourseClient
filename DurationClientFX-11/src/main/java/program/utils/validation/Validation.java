...
public class Validation {
    ...
    public static boolean isValidEditPersonRegex(RegistrationEditModel model, Stage stage) {
        ...
        if (!RegexValidation.checkName(model.firstNameField.getText())
                || !RegexValidation.checkName(model.lastNameField.getText()))
    ...
    public static boolean isValidAuthorizationRegex(SignInModel model, Stage stage) {
        if (RegexValidation.checkEmail(model.emailField.getText()) && RegexValidation.checkPassword(model.passwordField.getText()))
            return true;
        else {
     ...
     */
    public static boolean isNameBlank(String text) {
